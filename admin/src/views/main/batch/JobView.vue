      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.dataIndex === 'operation'">
          <a-space>
            ...
            <a-button type="primary" @click="handleEdit(record)" size="small" block>
              编辑
            </a-button>
            <a-popconfirm
                title="删除后不可恢复，确认删除?"
            ...
            >
              <a-button type="primary" size="small" danger block>
                删除
              </a-button>
            </a-popconfirm>
          </a-space>
    ...
    >
      <a-form :model="job" :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
        ...
        <a-form-item label="表达式">
          ...
          <a-alert type="success" style="padding: 10px 20px;font-size: 13px;color:#00000095">
