  ...
  <a-modal v-model:visible="visible" title="车次" @ok="handleOk"
    ...
    <a-form :model="train" :label-col="{span: 4}" :wrapper-col="{ span: 20 }">
      ...
      <a-form-item label="始发站">
        <StationSelectComponent v-model:value="train.start"></StationSelectComponent>
      </a-form-item>
      ...
      <a-form-item label="终点站">
        <StationSelectComponent v-model:value="train.end"></StationSelectComponent>
      </a-form-item>
...
export default defineComponent({
  name: "TrainView",
  components: {StationSelectComponent},
  setup() {
